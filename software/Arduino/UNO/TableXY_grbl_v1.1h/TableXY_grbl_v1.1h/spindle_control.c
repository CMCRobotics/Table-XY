...
// No pencil control through sindle
  ...
  */
  ...
  {     // On the Uno, spindle enable and PWM are shared. Other CPUs have seperate enable pin.
            ...
            SPINDLE_OCR_REGISTER = RC_SERVO_LONG;
        #else
    ...
    if (direction == SPINDLE_DISABLE) {
      ...
      if (direction == SPINDLE_ENABLE_CW) {
        ...
        #define RC_SERVO_RANGE (RC_SERVO_LONG-RC_SERVO_SHORT)
          ...
          SPINDLE_TCCRA_REGISTER = (1<<SPINDLE_COMB_BIT) | (1<<SPINDLE_WAVE1_REGISTER) | (1<<SPINDLE_WAVE0_REGISTER);
          SPINDLE_TCCRB_REGISTER = (SPINDLE_TCCRB_REGISTER & 0b11111000) | 0x07 | (1<<SPINDLE_WAVE2_REGISTER) | (1<<SPINDLE_WAVE3_REGISTER); // set to 1/1024 Prescaler
          OCR4A = 0xFFFF; // set the top 16bit value
          uint16_t current_pwm;
      #else
          SPINDLE_TCCRA_REGISTER = (1<<SPINDLE_COMB_BIT) | (1<<SPINDLE_WAVE1_REGISTER) | (1<<SPINDLE_WAVE0_REGISTER);
          SPINDLE_TCCRB_REGISTER = (SPINDLE_TCCRB_REGISTER & 0b11111000) | 0x07; // set to 1/1024 Prescaler
        uint8_t current_pwm;
      #endif
