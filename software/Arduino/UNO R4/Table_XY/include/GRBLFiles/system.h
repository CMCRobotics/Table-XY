...
// Detection of Control/Limit line status
boolean checkControlLimitStatus (u_int16_t value, u_int8_t *counter, boolean active_low);
#define SOFTWARE_DEBOUNCE (5)     // number of times the line is detected as active on AGT1 interruption
                                  // this leads to SOFTWARE_DEBOUNCE * AGT1-interruption_period
#endif
...
// Memories only defined on Main
    #define MAIN_FILE_SYSTEM

#else

    #define MAIN_FILE_SYSTEM extern

#endif

MAIN_FILE_SYSTEM u_int8_t ControlAbortReset_ctr;     // Number of times line has been detected active/not active
MAIN_FILE_SYSTEM u_int8_t ControlResumeCycleStart_ctr;
MAIN_FILE_SYSTEM u_int8_t ControlFeedHoldSafetyDoor_ctr;


#define DEBUG_DATA_ARRAY_LENGTH 12
MAIN_FILE_SYSTEM u_int32_t debug_data[DEBUG_DATA_ARRAY_LENGTH];